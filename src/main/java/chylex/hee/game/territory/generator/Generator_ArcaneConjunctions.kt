...
import chylex.hee.game.world.generation.blob.populators.BlobPopulatorFill
import chylex.hee.game.world.generation.blob.populators.BlobPopulatorOre
...
import chylex.hee.game.world.generation.ore.impl.OreTechniqueDistance
...
object Generator_ArcaneConjunctions : ITerritoryGenerator {
	...
	private class Path(private val blob1: Blob, private val blob2: Blob, rand: Random) {
		...
		private fun getCenterPoint(progress: Double): Vector3d {
			return center1.lerpTowards(center2, progress).add(
