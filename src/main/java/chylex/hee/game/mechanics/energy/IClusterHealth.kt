...
interface IClusterHealth {
	...
	enum class HealthStatus(
		override val translationKey: String, override val textColor: IntColor,
		...
		HEALTHY ("hee.energy.health.healthy",  HCL(120.0, 80F, 74F), regenAmountMp = 1.0F,  regenSpeedMp = 1.5F, regenCapacityMp = 1.0F,  canDeteriorate = true),
		WEAKENED("hee.energy.health.weakened", HCL( 75.0, 80F, 74F), regenAmountMp = 0.9F,  regenSpeedMp = 1.2F, regenCapacityMp = 1.0F,  canDeteriorate = true),
		TIRED   ("hee.energy.health.tired",    HCL( 45.0, 85F, 70F), regenAmountMp = 0.6F,  regenSpeedMp = 0.8F, regenCapacityMp = 0.9F,  canDeteriorate = true),
		DAMAGED ("hee.energy.health.damaged",  HCL( 18.0, 90F, 66F), regenAmountMp = 0.4F,  regenSpeedMp = 0.5F, regenCapacityMp = 0.75F, leakChance = 0.5F / 100F),
		UNSTABLE("hee.energy.health.unstable", HCL(  0.0,  0F, 70F), regenAmountMp = 0.15F, regenSpeedMp = 0.2F, regenCapacityMp = 0.6F,  leakChance = 1.2F / 100F);
	...
	enum class HealthOverride(
		...
		POWERED("hee.energy.health.powered", HCL(210.0, 80F, 66F), regenAmountMp = 1.0F, regenSpeedMp = 2.0F, regenCapacityMp = 1.25F) {
		...
		REVITALIZING("hee.energy.health.revitalizing", HCL(320.0, 75F, 66F), regenAmountMp = 0.0F, regenSpeedMp = 1.0F, regenCapacityMp = 0.0F) {
