...
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonCorridor_Intersection
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonCorridor_Stairs
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonCorridor_Straight
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonCorridor_StraightCrumbling
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonCorridor_StraightTombs
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonDeadEnd_Tomb
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_End
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Main_BranchingHall
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Main_CrossroadRooms
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Main_Maze
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Main_Pillars
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Main_SplitRooms
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Side_Arches
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Side_Crossroads
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Side_CrossroadsLounge
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Side_Fountain
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Side_Shelves
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Tomb_Mass
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Tomb_MassSpacious
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Tomb_MultiDeep
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Tomb_MultiNarrow
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Tomb_MultiSpacious
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Tomb_SingleNarrow
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonRoom_Tomb_SingleSpacious
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonSecret
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonSecret_CornerShelf
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonSecret_LootChest
import chylex.hee.game.world.generation.feature.tombdungeon.piece.TombDungeonSecret_Rubble
import chylex.hee.game.world.generation.structure.IStructureDescription
import chylex.hee.game.world.generation.structure.IStructureDescription.Companion.NULL_LOCATOR
...
object TombDungeonPieces : IStructureDescription {
	...
	val PALETTE_ENTRY_FANCY_WALL = Weighted(
		932 to ModBlocks.DUSTY_STONE_BRICKS.defaultState,
		 52 to ModBlocks.DUSTY_STONE_CRACKED_BRICKS.defaultState,
		  2 to ModBlocks.DUSTY_STONE_BRICK_STAIRS.with(STAIRS_HALF, Half.BOTTOM).withFacing(NORTH),
		  2 to ModBlocks.DUSTY_STONE_BRICK_STAIRS.with(STAIRS_HALF, Half.BOTTOM).withFacing(SOUTH),
		  2 to ModBlocks.DUSTY_STONE_BRICK_STAIRS.with(STAIRS_HALF, Half.BOTTOM).withFacing(EAST),
		  2 to ModBlocks.DUSTY_STONE_BRICK_STAIRS.with(STAIRS_HALF, Half.BOTTOM).withFacing(WEST),
		  2 to ModBlocks.DUSTY_STONE_BRICK_STAIRS.with(STAIRS_HALF, Half.TOP).withFacing(NORTH),
		  2 to ModBlocks.DUSTY_STONE_BRICK_STAIRS.with(STAIRS_HALF, Half.TOP).withFacing(SOUTH),
		  2 to ModBlocks.DUSTY_STONE_BRICK_STAIRS.with(STAIRS_HALF, Half.TOP).withFacing(EAST),
		  2 to ModBlocks.DUSTY_STONE_BRICK_STAIRS.with(STAIRS_HALF, Half.TOP).withFacing(WEST),
	)
	...
	val PALETTE_ENTRY_FANCY_CEILING = Weighted(
		...
		100 to ModBlocks.DUSTY_STONE_CRACKED_BRICKS.defaultState,
		 10 to ModBlocks.DUSTY_STONE_BRICK_SLAB.with(SLAB_TYPE, SlabType.TOP),
		  3 to ModBlocks.DUSTY_STONE_BRICK_STAIRS.with(STAIRS_HALF, Half.TOP).withFacing(NORTH),
		  3 to ModBlocks.DUSTY_STONE_BRICK_STAIRS.with(STAIRS_HALF, Half.TOP).withFacing(SOUTH),
		  3 to ModBlocks.DUSTY_STONE_BRICK_STAIRS.with(STAIRS_HALF, Half.TOP).withFacing(EAST),
		  3 to ModBlocks.DUSTY_STONE_BRICK_STAIRS.with(STAIRS_HALF, Half.TOP).withFacing(WEST)
	)
