...
public final class RendererConstructors{
	private static final Map<Class<? extends EntityRenderer<?>>, IRenderFactory> all = new HashMap<>();
	...
	static{
		...
		all.put(RenderEntityMobAngryEnderman.class, RenderEntityMobAngryEnderman::new);
	...
	public static <T extends Entity, R extends EntityRenderer<? super T>> IRenderFactory get(Class<R> cls){
